...
namespace Util {
	...
	public class Utility {
		...
		public static string SceneToString(GameScene _gameScene)
		{
			switch (_gameScene)
			{
				case GameScene.SPLASH: return CONST.SCENE_SPLASH;
				case GameScene.MENU: return CONST.SCENE_MENU;
				case GameScene.LEVELS: return CONST.SCENE_LEVELS;
				case GameScene.PLAY: return CONST.SCENE_PLAY;
				default: return "NULL";
			}
		}
